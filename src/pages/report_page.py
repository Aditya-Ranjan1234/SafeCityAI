...
def render():
    ...
    with st.form("safety_report_form"):
        ...
        col1, col2 = st.columns(2)
        with col1:
            # Use April 2025 as the default date for the demo
            default_date = datetime(2025, 4, 10).date()
            date_noticed = st.date_input("When did you notice this issue?", default_date)
        with col2:
